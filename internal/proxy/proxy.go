...
// The outgoing Host header is always set to the upstream hostname.
...
func NewReverseProxy(upstream string, insecure bool, routePrefix string, upstreamPath string) (*httputil.ReverseProxy, error) {
