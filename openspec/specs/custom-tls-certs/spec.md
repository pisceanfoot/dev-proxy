# Spec: custom-tls-certs

## Purpose

Describes how dev-proxy loads, validates, and caches custom TLS certificates from disk, and how it surfaces actionable errors when a required port is already in use.
